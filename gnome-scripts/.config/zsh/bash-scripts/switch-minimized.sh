...
# To check the currently focus class name use command in terminal: sleep 1 && xdotool getactivewindow getwindowclassname
# and then change focus desired window
